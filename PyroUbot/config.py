...
DEVS = list(map(int, os.getenv("DEVS", "5706956809").split()))
...
OWNER_ID = int(os.getenv("OWNER_ID", "5706956809"))
...
LOGS_MAKER_UBOT = int(os.getenv("LOGS_MAKER_UBOT", "-1002810372081"))
